...
class AutoTimerMocapRecorder:
    ...
    def process_frame(self, timestamp):
        ...
        # Use actual camera IDs instead of hardcoded camera_0/camera_1
        cam_keys = list(frame_dict['landmarks_2d'].keys())
        if len(cam_keys) >= 2:
            landmarks_3d = []
            lm_cam0 = frame_dict['landmarks_2d'][cam_keys[0]]
            lm_cam1 = frame_dict['landmarks_2d'][cam_keys[1]]
